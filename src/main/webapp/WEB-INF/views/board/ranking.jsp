		...
		<div class="row">
			...
			<!-- 반복 시작  -->
                ...
                <div class="movie-item-style-2">    
                	<img src="<c:url value="/resources/images/uploads/${rankingmovie.mi_thumbnail}"/>" style="width:20%" />  
                	<div class="mv-item-infor">                 
	                    <h6><a href="<c:url value="/movie/${rankingmovie.mi_num}"/>"><c:out value="${rankingmovie.mi_title}"/></a></h6>
